...
def main():
   ...
   parser.add_argument('--env', type=str, default='sumo:SumoEnv-v0')
   ...
   parser.add_argument('--seed', type=int, default=np.random.randint(0,2**32),
                       help='Random seed [0, 2 ** 32)')
   parser.add_argument('--outdir', type=str, default='results',
                       help='Directory path to save output files.'
                            ' If it does not exist, it will be created.')
   parser.add_argument('--steps', type=int, default=5 * 10 ** 4)
   ...
   parser.add_argument('--logger-level', type=int, default=logging.INFO)#DEBUG
