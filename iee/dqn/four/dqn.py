...
def dqn():
    ...
    def get_state(c):
        if c == "c1":
            ...
            cars_b_c = traci.edge.getLastStepHaltingNumber("c3_c1")
            ...
            cars_b_c = traci.edge.getLastStepHaltingNumber("c4_c2")
            tate = (cars_t_c + cars_b_c)
            yoko = (cars_r_c + cars_l_c)
            ...
            cars_r_c = traci.edge.getLastStepHaltingNumber("c4_c3")
            cars_l_c = traci.edge.getLastStepHaltingNumber("l2_c3")
            cars_t_c = traci.edge.getLastStepHaltingNumber("c1_c3")
            cars_b_c = traci.edge.getLastStepHaltingNumber("b1_c3")
            tate = (cars_t_c + cars_b_c)
            yoko = (cars_r_c + cars_l_c)
            ...
            cars_r_c = traci.edge.getLastStepHaltingNumber("r2_c4")
            cars_l_c = traci.edge.getLastStepHaltingNumber("c3_c4")
            cars_t_c = traci.edge.getLastStepHaltingNumber("c2_c4")
            cars_b_c = traci.edge.getLastStepHaltingNumber("b2_c4")
            tate = (cars_t_c + cars_b_c)
            yoko = (cars_r_c + cars_l_c)
    ...
    def reward(c):
        if c == "c1":
            ...
            b_c = traci.edge.getLastStepHaltingNumber("c3_c1")
            ...
            b_c = traci.edge.getLastStepHaltingNumber("c4_c2")
            r =  -(t_c + r_c + l_c + b_c)/300
            return r
        elif c == "c3":
            t_c = traci.edge.getLastStepHaltingNumber("c1_c3")
            r_c = traci.edge.getLastStepHaltingNumber("c4_c3")
            l_c = traci.edge.getLastStepHaltingNumber("l2_c3")
            b_c = traci.edge.getLastStepHaltingNumber("b1_c3")
            r =  -(t_c + r_c + l_c + b_c)/300
            return r
        elif c == "c4":
            t_c = traci.edge.getLastStepHaltingNumber("c2_c4")
            r_c = traci.edge.getLastStepHaltingNumber("r2_c4")
            l_c = traci.edge.getLastStepHaltingNumber("c3_c4")
            b_c = traci.edge.getLastStepHaltingNumber("b2_c4")
            r =  -(t_c + r_c + l_c + b_c)/300
            return r
    ...
    mainQN3 = QNetwork(hidden_size=hidden_size, learning_rate=learning_rate)     # メインのQネットワーク
    targetQN3 = QNetwork(hidden_size=hidden_size, learning_rate=learning_rate)   # 価値を計算するQネットワーク

    mainQN4 = QNetwork(hidden_size=hidden_size, learning_rate=learning_rate)     # メインのQネットワーク
    targetQN4 = QNetwork(hidden_size=hidden_size, learning_rate=learning_rate)   # 価値を計算するQネットワーク
    # plot_model(mainQN.model, to_file='Qnetwork.png', show_shapes=True)        # Qネットワークの可視化
    memory1 = Memory(max_size=memory_size)
    memory2 = Memory(max_size=memory_size)
    memory3 = Memory(max_size=memory_size)
    memory4 = Memory(max_size=memory_size)
    # actor = Actor()
    ...
    targetQN3.model.set_weights(mainQN3.model.get_weights())
    targetQN4.model.set_weights(mainQN4.model.get_weights())
    for episode in range(20):
        ...
        state3 = get_state("c3")
        state3 = np.reshape(state2, [1, 3]) 
        state4 = get_state("c4")
        state4 = np.reshape(state2, [1, 3])      
        for step in range(1000):
            ...
            if phase_before1 == phase1:
                if num1 == 10:
                    ...
                    r1 = reward("c1")
                    memory1.add((before_state1, before_action1, r1, state1)) 
            ...
            if phase_before2 == phase2:
                if num2 == 10:
                    ...
                    r2 = reward("c2")
                    memory2.add((before_state2, before_action2, r2, state2)) 
            ...
            if phase_before3 == phase3:
                if num3 == 10:
                    before_state3 = state3
                    state3 = get_state("c3")
                    state3 = np.reshape(state3, [1, 3]) 
                    before_action3 = action3
                    action3 = get_action(state3, episode, mainQN3)
                    r3 = reward("c3")
                    memory3.add((before_state3, before_action3, r3, state3)) 
                    state_trans(action3,"c3")
                    # state = np.reshape(state, [1, 3]) 
            ...
            if phase_before4 == phase4:
                if num4 == 10:
                    before_state4 = state4
                    state4 = get_state("c4")
                    state4 = np.reshape(state4, [1, 3]) 
                    before_action4 = action4
                    action4 = get_action(state4, episode, mainQN4)
                    r4 = reward("c4")
                    memory4.add((before_state4, before_action4, r4, state4)) 
                    state_trans(action4,"c4")
                    # state = np.reshape(state, [1, 3]) 
